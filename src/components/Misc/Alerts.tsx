export function AdviceAlert({ message }: { message: string }) {
  return (
    <section className="bg-blue-100 p-5 w-full sm:w-1/2 border-l-4 border-blue-500">
      <div className="flex space-x-3">
        <svg viewBox="0 0 24 24" className="flex-none fill-current text-blue-500 h-4 w-4">
        ...
        <p className="flex-1 leading-tight text-sm text-blue-700">{message}</p>
      </div>
    </section>
  )
}
...
export function SuccessAlert({ message }: { message: string }) {
  return (
    <section className="bg-green-100 p-5 w-full sm:w-1/2 rounded">
      <div className="flex justify-between">
        <div className="flex space-x-3">
          <svg viewBox="0 0 24 24" className="flex-none fill-current text-green-500 h-4 w-4">
          ...
          <p className="flex-1 leading-tight text-sm text-green-700 font-medium">{message}</p>
        </div>
        <svg viewBox="0 0 24 24" className="flex-none fill-current text-green-600 h-3 w-3">
...
export function ErrorAlert({ message }: { message: string }) {
  return (
  <section className="bg-red-100 p-5 w-full sm:w-1/2">
    <div className="flex space-x-3">
      <svg viewBox="0 0 24 24" className="flex-none fill-current text-red-500 h-4 w-4">
