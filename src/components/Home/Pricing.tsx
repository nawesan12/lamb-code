  ...
  return (
    <section className="section">
      <div className="container px-6 py-8 mx-auto">
          <h1 className="text-3xl font-semibold text-center text-gray-800 capitalize lg:text-4xl">Simple pricing plan</h1>
          ...
          <div className="grid grid-cols-1 gap-8 mt-6 lg:grid-cols-3 xl:mt-12">
              <div className="flex items-center justify-between px-8 py-4 border cursor-pointer rounded-xl">
                  <div className="flex flex-col items-center space-y-1">
                      <svg className="w-5 h-5 text-gray-400 sm:h-7 sm:w-7" viewBox="0 0 20 20" fill="currentColor">
                          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                      </svg>

                      <h2 className="text-lg font-medium text-gray-700 sm:text-xl">Basic</h2>
                  </div>

                  <h2 className="text-2xl font-semibold text-gray-500 sm:text-3xl">Free</h2>
              </div>

              <div className="flex items-center justify-between px-8 py-4 border border-blue-500 cursor-pointer rounded-xl">
                  <div className="flex flex-col items-center space-y-1">
                      <svg className="w-5 h-5 text-blue-600 dark:text-blue-500 sm:h-7 sm:w-7" viewBox="0 0 20 20" fill="currentColor">
                          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                      </svg>

                      <h2 className="text-lg font-medium text-gray-700 sm:text-xl">Standard</h2>
                  </div>
              ...
              <div className="flex items-center justify-between px-8 py-4 border cursor-pointer rounded-xl">
                  <div className="flex flex-col items-center space-y-1">
                      ...
                      <h2 className="text-lg font-medium text-gray-700 sm:text-xl">Pro</h2>
                  </div>

                  <div className="flex flex-col items-center space-y-1">
                      <div className="px-2 text-xs text-blue-500 bg-gray-100 rounded-full">
                          Save 20%
                      </div>

                      <h2 className="text-2xl font-semibold text-gray-500 sm:text-3xl">$149 <span className="text-base font-medium">/Month</span></h2>
                  </div>
              </div>
          </div>
          ...
          <div className="p-8 mt-8 space-y-8 bg-gray-100 rounded-xl">
              <div className="flex items-center justify-between text-gray-800">
                  ...
                  <svg className="w-5 h-5 text-blue-500 sm:h-7 sm:w-7" viewBox="0 0 20 20" fill="currentColor">
                      <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                  </svg>
              </div>
              ...
              <div className="flex items-center justify-between text-gray-800">
                  ...
                  <svg className="w-5 h-5 text-red-400 sm:h-7 sm:w-7" viewBox="0 0 20 20" fill="currentColor">
