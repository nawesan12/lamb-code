      ...
      <div className="max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
        <section className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex justify-start gap-6 mt-8 sm:mt-0 sm:justify-end">
            <li>
              <a
                href="https://open.spotify.com/la-voz-de-la-tecnologia"
                rel="noreferrer"
                target="_blank"
              ...
              >
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li>
              ...
              >
                ...
                <svg width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
