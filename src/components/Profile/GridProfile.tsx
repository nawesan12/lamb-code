...
export default function GridProfile() {
  return (
    <div className="lg:grid lg:grid-cols-3 lg:gap-4 flex flex-col gap-8" style={{ gridColumn: "2 / 5", gridRow: "2 / 4" }}>

      <article className="flex flex-col lg:gap-3 gap-20 rounded-2xl bg-white p-8 py-12">
      ...
      <article className="flex flex-col lg:items-center lg:gap-3 gap-20 rounded-2xl bg-white p-8 py-12">
        ...
        <section className="flex items-center">
          ...
          />
          <div className="p-4">
            <h3 className="lg:text-xl font-bold text-4xl">Javascript for beginners</h3>
          </div>
        </section>
        ...
        <section className="flex items-center">
          ...
          />
          <div className="p-4">
            <h3 className="lg:text-xl font-bold text-4xl">Web Sockets with NodeJS</h3>
          </div>
        </section>
      </article>

      <article className="flex flex-col lg:items-center gap-20 rounded-2xl bg-white p-8 py-12">
