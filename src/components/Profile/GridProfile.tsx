...
export default function GridProfile() {
  return (
    <div className="lg:grid lg:grid-cols-3 lg:gap-4 flex flex-col gap-8" style={{ gridColumn: "2 / 5", gridRow: "2 / 4" }}>
      ...
      <article className="flex flex-col gap-20 rounded-2xl lg:gap-8 bg-white lg:py-4 p-8 py-12">
      ...
      <article className="flex flex-col lg:items-center lg:gap-8 gap-20 rounded-2xl lg:py-4 bg-white p-8 py-12">
